    ...
    for item in folder.iterdir():
        ...
        if not extension:
            ...
            try:
                ...
                ext_reg = ext_reg.append(full_name)
...
def main(folder: Path):
    ...
    for file in ZIP_ARCHIVES:
        handle_archives(file, folder / 'ZIP_ARCHIVES')

    for file in GZ_ARCHIVES:
        handle_archives(file, folder / 'GZ_ARCHIVES')

    for file in TAR_ARCHIVES:
        handle_archives(file, folder / 'TAR_ARCHIVES')
